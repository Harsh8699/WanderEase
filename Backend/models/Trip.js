...
const tripSchema = mongoose.Schema({
    ...
    blueprint: { tripDetails: tripDetailsSchema, route: routeSchema, weatherForecast: weatherForecastSchema, transportOptions: transportOptionsSchema, accommodation: accommodationSchema, budget: budgetSchema },
