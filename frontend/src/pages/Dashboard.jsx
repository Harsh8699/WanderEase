...
const Dashboard = () => {
  ...
  const handleDeleteTrip = async () => {
    ...
    setDeletingTripId(tripToDelete._id);
    try {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{tripToDelete?.tripName}"? This action cannot be undone.
              All trip data including itinerary, expenses, and polls will be permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
